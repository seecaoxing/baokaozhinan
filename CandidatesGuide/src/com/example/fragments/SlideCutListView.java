...
public class SlideCutListView extends ListView {
	...
	/**
	 * �?右滑动，getScrollX()返回的是左边缘的距离，就是以View左边缘为原点到开始滑动的距离，所以向右边滑动为负�?
	 */
			...
			if (scroller.isFinished()) {
				if (onItemRemovedListener == null) {
					throw new NullPointerException(
							"OnItemRemovedListener is null, we should called setOnItemRemovedListener()");
				}
				itemView.scrollTo(0, 0);
	...
	/**
	 * 
	 * 当ListView item滑出屏幕，回调这个接�? 我们�?要在回调方法removeItem()中移除该Item,然后刷新ListView
	 * 
	 * 
	 */
