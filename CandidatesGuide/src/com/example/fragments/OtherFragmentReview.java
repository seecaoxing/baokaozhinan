 ...
 * 
 */
public class OtherFragmentReview extends Activity {
	...
	private OtherArticle shareArticle = new OtherArticle();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.otherfragmentreview);
		initView();
		shareArticle = (OtherArticle) getIntent().getSerializableExtra(
				"otherArticle");
		updateReview();
		...
		okButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				tempReview.setFlagId(shareArticle.getOtherArticleId());
				tempReview.setReviewString(reviewString);
				tempReview.setTypeString("other");
	...
	private void updateReview() {
		...
		queryReview.addWhereEqualTo("typeString", "other");
		queryReview.addWhereEqualTo("flagId", shareArticle.getOtherArticleId());
	...
	private void initView() {
		reviewEditText = (EditText) findViewById(R.id.other_review_edit);
		okButton = (Button) findViewById(R.id.other_ok_button);
		reviewLV = (SlideCutListView) findViewById(R.id.other_review_lv);
		// cancerButton = (Button) findViewById(R.id.other_cancer_button);
